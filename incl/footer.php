<section id="social" class="bg-illinois-blue" style="padding: 30px 0;">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 text-center illinois-orange-text">
                ...
                <hr>
                <h6>&copy; Copyright 2017 Model United Nations Illinois. <strong>Header photo credit: <?php if(isset($footerPhotoCredit)) { echo $footerPhotoCredit; } else { echo "Andrew Bonsu"; }?></strong></h6>
            </div>
        </div>
    </div>
</section>
...
<script src="assets/js/muni.js"></script>
<?php if(isset($extra_bottom)) { echo $extra_bottom; } ?>
</body>
</html>
