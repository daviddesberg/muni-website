...
<section>
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h3><span class="illinois-blue-text">OUR</span> <span class="illinois-orange-text">VISION</span></h3>
                <p>
